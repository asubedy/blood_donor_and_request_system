	...
	if(isset($_POST['term']) === true){
		...
		if(isset($_POST['name']) && !empty($_POST['name'])){
			...
			if(preg_match('/^[A-Za-Z\s]+$/',$_POST['name'])){
				...
				<strong>Please Enter your name according to the naming conventions (only lowercase and capital case letter are allowed) .</strong>
